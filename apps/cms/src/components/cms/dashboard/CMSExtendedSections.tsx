import { Globe2, ImagePlus, Plus, Upload } from 'lucide-react';
...
export function SettingsSection(props: SettingsSectionProps) {
  ...
  return <div className="space-y-6"><AdminPageHeader title="Paramètres" subtitle="Gérez l’identité de marque, les informations globales et les métadonnées publiques." />
    ...
    <AdminActionBar><div className="text-[12px] text-[#60737b]">{settingsHasUnsavedChanges ? 'Modifications non sauvegardées.' : 'Paramètres à jour.'}</div><AdminButton onClick={saveSettings} disabled={settingsSaving}>{settingsSaving ? 'Sauvegarde...' : 'Sauvegarder les paramètres'}</AdminButton></AdminActionBar>
  </div>;
}
