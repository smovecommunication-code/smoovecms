...
function MediaLibraryThumbnail({ file }: { file: MediaFile }) {
  ...
  return <div className="flex h-[124px] items-center justify-center text-[12px] text-[#6f7f85]">{thumb.kind === 'missing' ? 'Image non résolue' : file.type === 'video' ? 'Aperçu vidéo' : 'Fichier document'}</div>;
}
